...
export default function ChatSessionList({ activeSessionId, onSelect, onNewChat, onClose }) {
            ...
            <div className="flex flex-col gap-0.5">
              {sessions.map((s) => (
                <button
                  ...
                  className={`text-left text-xs px-2 py-1.5 rounded-md truncate ${s.id === activeSessionId ? "bg-primary/15 text-primary font-medium" : "hover:bg-secondary"}`}
                >
